   ...
   SearchView.OnQueryTextListener listener = new SearchView.OnQueryTextListener() {
    ...
    public void refreshList() {
        ...
        if (pageCount < totalPages) {
            ...
            Toast.makeText(MainActivity.this, "Press Reload to back to first page.", Toast.LENGTH_LONG).show();
        }
        ...
        try {
            ...
            jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url.trim(), params,
                ...
                public void onErrorResponse(VolleyError volleyError) {
                    ...
                    Util.hideAlertDialog();
                    Util.showAlertDialog(MainActivity.this, "Alert", "Error: " + volleyError.toString(), true, SweetAlertDialog.ERROR_TYPE);
                }
            });
                        ...
                        public void onResponse(JSONObject jsonObject) {
                            try {
                                if (jsonObject.getBoolean("STATUS")) {
                                    ...
                                    Util.showAlertDialog(MainActivity.this, "Deleted.", true, SweetAlertDialog.SUCCESS_TYPE);
